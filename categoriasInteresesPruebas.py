    ...
    for word in column:
      ...
      if type(word) != float:
        ...
        for gender in filter_ALL_genders:
          ...
          response = natural_language_understanding.analyze(text = acumulado_acumulado, language = "es", features=Features(sentiment=SentimentOptions(document=True))).get_result()
